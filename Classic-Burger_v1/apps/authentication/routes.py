...
from apps.authentication.models import User, Table, Item, Order
from apps.authentication.forms import RegisterForm, LoginForm, OrderIDForm, ReserveForm, AddForm, OrderForm
...
@blueprint.route('/congrats')
def congrats_page():
    return render_template('congrats.html')   

#TABLE RESERVATION PAGE
@blueprint.route('/table', methods = ['GET', 'POST'])
@login_required
def table_page():
...
#ORDER ID PAGE
@blueprint.route('/order_id', methods = ['GET', 'POST'])
def track_page():
    orderid = OrderIDForm()
    # if request.method == "POST":
...
@blueprint.route('/deliverytracking')
def delivery():
